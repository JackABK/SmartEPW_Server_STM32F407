...
static unsigned int CH1Distance[2];
static unsigned int CH2Distance[2];
static unsigned int CH3Distance[2];
static unsigned int CH4Distance[2];

static xTimerHandle ultrasoundTimers;

static unsigned int IC3CH1ReadValue1,IC3CH1ReadValue2, IC3CH2ReadValue1,IC3CH2ReadValue2;
static unsigned char CH1CaptureNumber=0,CH2CaptureNumber=0;

static unsigned int IC3CH3ReadValue1,IC3CH3ReadValue2, IC3CH4ReadValue1,IC3CH4ReadValue2;
...
void issue_sound_pulse(){
		...
		/*Send the trigger high  signal to 4 chanel*/
		...
		/*Send the trigger low  signal to 4 chanel*/
...
{
		xTimerDelete(ultrasoundTimers,0);
}
void init_echo(){
...
unsigned int Get_CH1Distance(){
		if((int)(CH1Distance[1]-CH1Distance[0])>100 || (int)(CH1Distance[0]-CH1Distance[1])>100)
				return 0;
		return CH1Distance[0];
}

unsigned int Get_CH2Distance(){
		if((int)(CH2Distance[1]-CH2Distance[0])>100 || (int)(CH2Distance[0]-CH2Distance[1])>100)
				return 0;
		return CH2Distance[0];

}
unsigned int Get_CH3Distance(){
		if((int)(CH3Distance[1]-CH3Distance[0])>100 || (int)(CH3Distance[0]-CH3Distance[1])>100)
				return 0;
		return CH3Distance[0];

}
unsigned int Get_CH4Distance(){
		if((int)(CH4Distance[1]-CH4Distance[0])>100 || (int)(CH4Distance[0]-CH4Distance[1])>100)
				return 0;
